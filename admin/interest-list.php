...
<head>
    ...
    <title>Interest List - LuckyGenes Admin</title>
...
<body>
    ...
    <div class="admin-container">
        ...
        <?php if (isset($success)): ?><div class="glass-card-teal-left p-3 mb-3 text-teal"><?php echo htmlspecialchars($success); ?></div><?php endif; ?>
        <?php if (isset($error)): ?><div class="glass-card-error p-3 mb-3 text-error"><?php echo htmlspecialchars($error); ?></div><?php endif; ?>
        ...
        <div class="admin-card" style="margin-bottom: 2rem;">
            <form method="GET" class="filters-form">
                <div class="form-group" style="flex:1; margin-bottom:0;">
                    <label>Search</label>
                    <input type="text" name="search" placeholder="Search by name, email, phone, or role..." value="<?php echo htmlspecialchars($search); ?>" class="form-control">
                </div>
        ...
        <div class="admin-card" style="padding:0; overflow:hidden;">
            <?php if (empty($subscribers)): ?>
                <div style="text-align:center; padding:4rem 2rem;">
                    ...
                    <p style="color:var(--color-text-gray);">People who join the interest list will appear here.</p>
                </div>
            <?php else: ?>
                <div style="padding: 1rem; border-bottom: 1px solid var(--color-border); background: var(--color-off-white); display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
                    ...
                    <span style="font-size: 0.85rem; color: var(--color-text-gray);">Select items below to perform bulk actions</span>
                </div>
                    ...
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="max-width: 300px; font-size: 0.9rem; color: var(--color-text-gray);">
                                ...
                                <td>
                                    <button type="submit" name="delete_id" value="<?php echo $sub['id']; ?>" class="btn btn-outline btn-sm" style="color: var(--color-red-accent); border-color: var(--color-red-accent);" onclick="return confirm('Are you sure you want to delete this subscriber?');">Delete</button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
