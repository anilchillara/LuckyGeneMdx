...
<body>
    ...
    <div class="glass-card">
        ...
        <div style="text-align: center; margin-top: 2rem; display: flex; flex-direction: column; gap: 10px;">
            ...
            <a href="../index.php" style="color: var(--text-dim); font-size: 0.75rem; text-decoration: none;">Exit to LuckyGeneMDx Home</a>
        </div>
    </div>
