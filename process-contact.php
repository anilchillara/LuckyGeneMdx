...
$to_email = "support@LuckyGenes.com"; // Default
if ($role === 'provider') {
    $to_email = "providers@LuckyGenes.com";
} elseif ($role === 'partner') {
    $to_email = "partnerships@LuckyGenes.com";
}
...
<body>
    <div class='header'>
        <h2>LuckyGenes Incoming Inquiry</h2>
    </div>
    <div class='content'>
        ...
        <div class='meta'>
            Sent via LuckyGenes Contact Portal<br>
...
$headers .= "From: LuckyGenes Portal <noreply@LuckyGenes.com>" . "\r\n";
...
<head>
    <meta charset="UTF-8">
    <title>Inquiry Received | LuckyGenes</title>
