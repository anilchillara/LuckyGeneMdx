...
('Patient Login', 'user-portal/login.php', 10, 1, 'actions', 2, 'btn-nav btn-nav-primary'),
('Order Kit', 'request-kit.php', 11, 1, 'actions', 2, 'btn-nav btn-nav-outline'),
('Dashboard', 'user-portal/index.php', 10, 1, 'actions', 1, 'btn-nav btn-nav-primary'),
('Sign Out', 'user-portal/logout.php', 11, 1, 'actions', 1, 'btn-nav btn-nav-outline');