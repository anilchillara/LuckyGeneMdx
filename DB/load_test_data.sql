...
-- 2. INSERT USERS (John Doe will now definitely be ID 1)
INSERT INTO users (email, password_hash, full_name, is_active, phone, dob, created_at, last_login) VALUES
('john.doe@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'John Doe', 1, '555-0101', '1990-05-15', '2024-01-10 10:30:00', '2024-02-10 14:20:00'),
('sarah.johnson@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Sarah Johnson', 1, '555-0102', '1988-08-22', '2024-01-12 09:15:00', '2024-02-12 16:45:00'),
-- ... [Include all 20 users here] ...
('nicole.allen@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Nicole Allen', 1, '555-0120', '1990-09-14', '2024-02-14 10:00:00', '2024-02-14 17:20:00');

-- 3. INSERT ORDERS (Now safely references user_id 1-20)
INSERT INTO orders (user_id, order_number, status_id, order_date, shipping_address_line1, shipping_city, shipping_state, shipping_zip, tracking_number, price, payment_status, payment_id) VALUES
(1, 'LGM-2024-00001', 5, '2024-01-10 10:35:00', '123 Main St', 'Boston', 'MA', '02108', '1Z999AA10123456784', 99.00, 'completed', 'pi_3abc123def456'),
(2, 'LGM-2024-00002', 5, '2024-01-12 09:20:00', '456 Oak Ave', 'Austin', 'TX', '78701', '1Z999AA10123456785', 99.00, 'completed', 'pi_3abc123def457');

-- 4. INSERT RESULTS (Now safely references order_id 1-3)
...
-- ('john.doe@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'John Doe', 1, '555-0101', '1990-05-15', '2024-01-10 10:30:00', '2024-02-10 14:20:00'),
-- ('sarah.johnson@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Sarah Johnson', 1, '555-0102', '1988-08-22', '2024-01-12 09:15:00', '2024-02-12 16:45:00'),
-- ('michael.chen@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Michael Chen', 1, '555-0103', '1992-03-30', '2024-01-15 11:20:00', '2024-02-08 10:30:00'),
-- ('emily.williams@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Emily Williams', 1, '555-0104', '1985-12-08', '2024-01-18 14:45:00', '2024-02-14 09:15:00'),
-- ('david.martinez@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'David Martinez', 1, '555-0105', '1993-07-19', '2024-01-20 08:30:00', '2024-02-13 15:20:00'),
-- ('jessica.brown@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Jessica Brown', 1, '555-0106', '1991-11-25', '2024-01-22 16:00:00', '2024-02-11 11:40:00'),
-- ('robert.taylor@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Robert Taylor', 1, '555-0107', '1987-04-12', '2024-01-25 10:15:00', '2024-02-09 13:25:00'),
-- ('amanda.anderson@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Amanda Anderson', 1, '555-0108', '1994-09-03', '2024-01-28 13:30:00', '2024-02-14 10:50:00'),
-- ('james.wilson@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'James Wilson', 1, '555-0109', '1989-06-17', '2024-02-01 09:45:00', '2024-02-12 14:15:00'),
-- ('lisa.moore@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Lisa Moore', 1, '555-0110', '1986-02-28', '2024-02-03 11:20:00', '2024-02-13 16:30:00'),
-- ('daniel.garcia@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Daniel Garcia', 1, '555-0111', '1995-10-14', '2024-02-05 15:10:00', '2024-02-14 09:45:00'),
-- ('jennifer.lee@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Jennifer Lee', 1, '555-0112', '1990-01-20', '2024-02-06 10:30:00', '2024-02-13 12:20:00'),
-- ('christopher.white@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Christopher White', 1, '555-0113', '1988-07-08', '2024-02-07 14:15:00', '2024-02-14 15:10:00'),
-- ('michelle.harris@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Michelle Harris', 1, '555-0114', '1992-05-26', '2024-02-08 09:00:00', '2024-02-12 10:35:00'),
-- ('matthew.clark@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Matthew Clark', 1, '555-0115', '1991-12-11', '2024-02-09 16:45:00', '2024-02-14 11:20:00'),
-- ('laura.rodriguez@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Laura Rodriguez', 1, '555-0116', '1987-03-05', '2024-02-10 11:30:00', '2024-02-13 14:40:00'),
-- ('kevin.lewis@email.com', '$2y$10$92IXUNpk$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Kevin Lewis', 1, '555-0117', '1993-08-18', '2024-02-11 13:20:00', '2024-02-14 16:15:00'),
-- ('stephanie.walker@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Stephanie Walker', 1, '555-0118', '1989-11-02', '2024-02-12 08:45:00', '2024-02-13 09:30:00'),
-- ('brian.hall@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Brian Hall', 1, '555-0119', '1994-04-22', '2024-02-13 15:30:00', '2024-02-14 13:45:00'),
-- ('nicole.allen@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Nicole Allen', 1, '555-0120', '1990-09-14', '2024-02-14 10:00:00', '2024-02-14 17:20:00');
-- ============================================
...
('labtech1@LuckyGenes.com', '192.168.1.105', '2024-02-14 08:30:00', TRUE),
...
('support1@LuckyGenes.com', '192.168.1.110', '2024-02-14 10:00:00', TRUE),
...
('michael.chen@email.com', 'Your Kit Has Shipped', 'Your LuckyGenes carrier screening kit has been shipped. Tracking: 1Z999AA10123456786', 'kit_shipped', 3, 'sent', 1, '2024-01-17 10:00:00', '2024-01-17 10:01:00'),
...
('nicole.allen@email.com', 'Welcome to LuckyGenes', 'Thank you for registering with LuckyGenes!', 'welcome', 5, 'sent', 1, '2024-02-14 10:01:00', '2024-02-14 10:02:00');

-- ============================================
-- Populate default settings used in settings.php
-- ============================================
INSERT IGNORE INTO site_settings (setting_key, value) VALUES
('site_name', 'LuckyGenes'),
('site_url', 'https://LuckyGenes.com'),
('support_email', 'support@LuckyGenes.com'),
...
('smtp_username', ''),
('smtp_password', ''),
('from_email', 'noreply@LuckyGenes.com'),
('from_name', 'LuckyGenes'),
('session_timeout', '30'),
('force_https', '1'),
('enable_2fa', '0');
